...
import { WebAuthnOwnableValidator } from "src/WebAuthnOwnableValidator.sol";
...
contract WebAuthnOwnableValidatorIntegrationTest is BaseIntegrationTest {
    ...
    function test_SetThreshold() public {
        ...
        instance.getExecOps({
            ...
            value: 0,
            callData: abi.encodeWithSelector(WebAuthnOwnableValidator.setThreshold.selector, newThreshold),
    ...
    function test_AddOwner() public {
        ...
        instance.getExecOps({
            target: address(validator),
            value: 0,
            callData: abi.encodeWithSelector(WebAuthnOwnableValidator.addOwner.selector, _owner),
            txValidator: address(instance.defaultValidator)
        }).execUserOps();
    ...
    function test_RemoveOwner() public {
        ...
        instance.getExecOps({
            ...
            callData: abi.encodeWithSelector(
                WebAuthnOwnableValidator.removeOwner.selector, SENTINEL, _owners[1]
            ),
            txValidator: address(instance.defaultValidator)
        }).execUserOps();
