...
import {
    WebAuthnOwnableValidator,
    ERC7579ValidatorBase,
    SENTINEL
} from "src/WebAuthnOwnableValidator.sol";
...
contract WebAuthnOwnableValidatorTest is BaseTest {
    using LibSort for *;
    ...
    WebAuthnOwnableValidator internal validator;
    ...
    function setUp() public virtual override {
        BaseTest.setUp();
        validator = new WebAuthnOwnableValidator();
    ...
    function test_OnInstallRevertWhen_ThresholdIs0() public whenModuleIsNotIntialized {
        ...
        vm.expectRevert(abi.encodeWithSelector(WebAuthnOwnableValidator.ThresholdNotSet.selector));
        validator.onInstall(data);
    }
        ...
        whenThresholdIsNot0
    {
        ...
        vm.expectRevert(abi.encodeWithSelector(WebAuthnOwnableValidator.InvalidThreshold.selector));
        validator.onInstall(data);
    }
        ...
        whenOwnersLengthIsNotLessThanThreshold
    {
        ...
        vm.expectRevert(abi.encodeWithSelector(WebAuthnOwnableValidator.MaxOwnersReached.selector));
        validator.onInstall(data);
    }
        ...
        whenOwnersLengthIsNotMoreThanMax
    {
        ...
        vm.expectRevert(abi.encodeWithSelector(WebAuthnOwnableValidator.InvalidOwner.selector, address(0)));
        validator.onInstall(data);
    }
        ...
        whenOwnersLengthIsNotMoreThanMax
    {
        ...
        vm.expectRevert(abi.encodeWithSelector(WebAuthnOwnableValidator.NotSortedAndUnique.selector));
        validator.onInstall(data);
    }
    ...
    function test_SetThresholdRevertWhen_ThresholdIs0() external whenModuleIsIntialized {
        ...
        vm.expectRevert(WebAuthnOwnableValidator.InvalidThreshold.selector);
    ...
    function test_AddOwnerRevertWhen_OwnerIs0Address() external whenModuleIsIntialized {
        ...
        vm.expectRevert(abi.encodeWithSelector(WebAuthnOwnableValidator.InvalidOwner.selector, newOwner));
    ...
    function test_Name() public {
        // it should return WebAuthnOwnableValidator
        string memory name = validator.name();
        assertEq(name, "WebAuthnOwnableValidator");
    }
